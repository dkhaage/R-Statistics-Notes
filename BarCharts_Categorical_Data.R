...
# R doesn't create bar charts directly from the categorical variables;
# instead, we must first create a table that has the frequencies for each level of the variable.
