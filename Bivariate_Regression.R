...
# NOTE: Correlation is used to test the strength of the association
# Regression allows you to PREDICT values based on another variable
...
# One variable predicting an outcome on a second quantitative variable
# One of the basic measures of associations in statistics
