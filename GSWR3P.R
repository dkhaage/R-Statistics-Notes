plantGrowthExpt <- read.csv('plantGrowthExpt.csv', header = TRUE)
...
plantGrowthExpt$bh.ratio <- with(plantGrowthExpt, biomass.gm/ height.cm)

plantGrowthExpt$sqrt.biom <- with(plantGrowthExpt, sqrt(biomass.gm))
